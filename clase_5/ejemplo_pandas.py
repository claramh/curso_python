...
leer_tsv = pd.read_csv(fichero_tsv, sep="\t", encoding="ISO-8859-1")

print(leer_csv.head(10)) # leer del fichero el encabezado, las 10 primeras líneas
print(leer_tsv.head()) # leer del fichero el encabezado, las primeras líneas
